...
makeFarmRow("Parkur Money Farm", function()
	local parkourFolder = workspace:FindFirstChild("ParkourMoney")
	if not parkourFolder then
		warn("ParkourMoney klasörü bulunamadı!")
		return
	end
